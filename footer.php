    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-3">
                ...
                <a href="<?php echo esc_attr(get_option("facebook")) ?>"><img
                        src=<?php echo $path."/images/facebook.png"?> alt="facebook"></a>
                <a href="<?php echo esc_attr(get_option("twitter")) ?>"><img
                        src=<?php echo $path."/images/twitter.png"?> alt="twitter"></a>
                <a href="<?php echo esc_attr(get_option("linkedin")) ?>"><img
                        src=<?php echo $path."/images/linkedin.png"?> alt="linkedin"></a>
                <a href="<?php echo esc_attr(get_option("instagram")) ?>"><img
                        src=<?php echo $path."/images/instagram.png"?> alt="instagram"></a>
            </div>
